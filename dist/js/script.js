  ...
  const particles = function () {
    ...
    function animateParticles(context) {
      ...
      for (let i = 0; i < _particleArrayTotalSize; i += _particleFields) {
        ...
        _particles[i + 3] += random() / 4 * SIN(random() * PI2) + _perlin.noise(_particles[i] / _gridShrinkFactor, _particles[i + 1] / _gridShrinkFactor, NOW() / _zComponentShrink); //approach coordinates of target pixel if one has been assigned to this specific particle
